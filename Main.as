	...
	public class Main extends Sprite {
		...
		public function menuSelect(e:Event):void{
			if(e.target == tools.dFile){
				...
				var safetyheight:Number = Global.unit == "in" ? 0.125 : 5;
				var stocksurface:String = "0";
				var targetdepth:Number  = Global.unit == "in" ? -0.76 : -10;
				var stepdown:Number = Global.unit == "in" ? 0.03125 : 1;
				var stepover:Number = 40;
				var feedrate:Number = Global.unit == "in" ? 30 : 500;
				var plungerate:Number = Global.unit == "in" ? 10 : 200;

				var tooldiameter:Number = Global.unit == "in" ? 0.125 : 3;
